...
const AllRooms = () => {
  ...
  const sortOptions = ["Price to High", "Price High to Low", "Newest First"]
  ...
  return (
    <div className='pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32'>
      ...
      <div className="flex flex-col lg:flex-row gap-10 mt-10">
        ...
        {/* Filter Section */}
        <div className={`bg-white w-80 border border-gray-300 text-gray-600 max-lg:mb-8 min-lg:mt-16 px-5 py-6 rounded-xl h-fit
          ${openFilters ? 'block' : 'hidden'} lg:block transition-all duration-700`}>
